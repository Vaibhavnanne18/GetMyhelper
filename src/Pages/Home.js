                    ...
                    <div className="home-text wow fadeIn text-center">
                      <h1 className="cd-headline clip is-full-width">
                        ...
                        >
                          ...
                          <b className="is-hidden">Gaurav Gangurde</b>
                          <b className="is-visible">Sanjana Haridas</b>
                        </span>
                      </h1>
                ...
                <div className="row">
                  <div className="col-md-12">
                    <div className="main-title text-center wow fadeIn">
                      ...
                      <p>
                      We specialize in developing cutting-edge recommendation algorithms to tailor content and product suggestions for users, ensuring a personalized and engaging experience. Our expertise covers collaborative filtering, content-based, and deep learning techniques, enabling businesses to enhance user engagement and drive customer satisfaction through effective recommendation systems.
                      </p>
                    </div>
                  </div>
                </div>
